...
import ProjetCards from '../components/projects/ProjetCards'
...
function Projects() {
...

  {
    ...
    image12: 'https://k72.ca/uploads/caseStudies/BAnQ_100TEMPS/100temps_Thumbnail-1280x960.jpg',
  },
  {
  ...
  useGSAP(function () {
    ...
    <div className='lg:p-4 p-2 mb-[100vh]'>
      <div className=' pt-[45vh]'>
        <h2 className='font-[font2] lg:text-[9.5vw] text-black text-7xl uppercase'>Projets</h2>
      </div>
      <div className='-lg:mt-20 lol'>
        {projets.map(function (elem, idx) {
          return <div key={idx} className='hero w-full lg:h-[350px] h-[300] mb-4 flex lg:flex-row flex-col lg:gap-4 gap-2'>
            <ProjetCards image1={elem.image1} image2={elem.image2} />
          </div>
        })}
